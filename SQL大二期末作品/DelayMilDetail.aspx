<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DelayMilDetail.aspx.cs" Inherits="DelayMilDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [DelayTable] WHERE [sid] = @sid" InsertCommand="INSERT INTO [DelayTable] ([name], [inschool], [birth], [sid], [housereg], [college], [Department], [schoolyear], [semester], [prove]) VALUES (@name, @inschool, @birth, @sid, @housereg, @college, @Department, @schoolyear, @semester, @prove)" SelectCommand="SELECT * FROM [DelayTable]" UpdateCommand="UPDATE [DelayTable] SET [name] = @name, [inschool] = @inschool, [birth] = @birth, [housereg] = @housereg, [college] = @college, [Department] = @Department, [schoolyear] = @schoolyear, [semester] = @semester, [prove] = @prove WHERE [sid] = @sid">
        <DeleteParameters>
